Item.create(name: "Chocolate Milk", description: "Cows are raised on only the finest swiss 
...
Item.create(name: "Almond Milk", description: "We allow our cows to graze in our almond fields only when the almonds are at their peak ripeness.
 This makes our almond milk a seasonal treat!", cost: 60.50)
Item.create(name: "Orange Banana Milk", description: "Fed with organic oranges from Florida and the freshest jungle bananas from Costa Rica. This
